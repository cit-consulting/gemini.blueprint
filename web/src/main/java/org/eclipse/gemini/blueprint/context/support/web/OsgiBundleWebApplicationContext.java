package org.eclipse.gemini.blueprint.context.support.web;
 ...
 * @author Costin Leau
 */
public class OsgiBundleWebApplicationContext extends OsgiBundleApplicationContext implements
    ...
    public OsgiBundleWebApplicationContext() {
        super(new String[]{});
